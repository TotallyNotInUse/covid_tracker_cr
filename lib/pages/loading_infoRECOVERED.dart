...
class LoadinginfoR extends StatefulWidget {
  @override
  _LoadingState createState() => _LoadingState();
}

class _LoadingState extends State<LoadinginfoR> {
  void getData() async {
    try {
      ...
      Navigator.pushReplacementNamed(context, "/cases_r", arguments: {
        "casesYesterday": dataY["recovered"],
        "casesToday": dataT["recovered"]
      });
    } catch (e) {
      print(e);
