...
class LoadinginfoD extends StatefulWidget {
  @override
  _LoadingState createState() => _LoadingState();
}

class _LoadingState extends State<LoadinginfoD> {
  void getData() async {
    try {
      ...
      Navigator.pushReplacementNamed(context, "/cases_d", arguments: {
        "casesYesterday": dataY["deaths"],
        "casesToday": dataT["deaths"]
      });
    } catch (e) {
      print(e);
